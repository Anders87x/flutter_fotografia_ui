...
import 'package:flutter_fotografias_ui/data/Sample.dart';
import 'package:flutter_fotografias_ui/helper/Colorsys.dart';
import 'package:flutter_fotografias_ui/models/Post.dart';
import 'package:flutter_fotografias_ui/pages/SinglePost.dart';
import 'package:flutter_fotografias_ui/pages/SingleUser.dart';
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text("Recomendado", style: TextStyle(
  ...
  Widget searchBox() {
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          SizedBox(height: 20,),
          Text("El mejor lugar para\nbuscar fotografias", style: TextStyle(
            fontSize: 22,
            color: Colorsys.darkGray,
            fontWeight: FontWeight.bold
          ),),
